...
internal class RebuildService
{
    ...
    public long Rebuild(RebuildOptions options)
    {
        ...
        var backupLogFilename =
            FileHelper.GetSuffixFile(FileHelper.GetLogFile(_settings.Filename), "-backup", true);
    ...
    private byte[] ReadFirstBytes()
    {
        ...
        var factory = _settings.CreateDataFileFactory();

        try
        {
            var access = factory.Access;
