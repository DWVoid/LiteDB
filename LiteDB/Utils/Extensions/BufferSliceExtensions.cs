...
internal static class BufferSliceExtensions
{
    ...
    public static byte ReadByte(this BufferSlice buffer, int offset) =>
        buffer.Array[buffer.Offset + offset];

    public static short ReadInt16(this BufferSlice buffer, int offset) => 
        Unsafe.ReadUnaligned<short>(ref buffer.Array[buffer.Offset + offset]);

    public static ushort ReadUInt16(this BufferSlice buffer, int offset) => 
        Unsafe.ReadUnaligned<ushort>(ref buffer.Array[buffer.Offset + offset]);

    public static int ReadInt32(this BufferSlice buffer, int offset) => 
        Unsafe.ReadUnaligned<int>(ref buffer.Array[buffer.Offset + offset]);

    public static uint ReadUInt32(this BufferSlice buffer, int offset) => 
        Unsafe.ReadUnaligned<uint>(ref buffer.Array[buffer.Offset + offset]);

    public static long ReadInt64(this BufferSlice buffer, int offset) => 
        Unsafe.ReadUnaligned<long>(ref buffer.Array[buffer.Offset + offset]);

    public static double ReadDouble(this BufferSlice buffer, int offset) => 
        BitConverter.Int64BitsToDouble(Unsafe.ReadUnaligned<long>(ref buffer.Array[buffer.Offset + offset]));
    ...
    public static decimal ReadDecimal(this BufferSlice buffer, int offset)
    {
        ...
        return new decimal(stackalloc int[] { a, b, c, d });
    }
    ...
    public static void Write(this BufferSlice buffer, short value, int offset) => 
        Unsafe.WriteUnaligned(ref buffer.Array[buffer.Offset + offset], value);
    ...
    public static void Write(this BufferSlice buffer, double value, int offset)
        => Unsafe.WriteUnaligned(ref buffer.Array[buffer.Offset + offset], BitConverter.DoubleToInt64Bits(value));
    ...
    public static void Write(this BufferSlice buffer, decimal value, int offset)
    {
        ...
        buffer.Write(buf[0], offset);
        buffer.Write(buf[1], offset + 4);
        buffer.Write(buf[2], offset + 8);
        buffer.Write(buf[3], offset + 12);
    }

    public static void Write(this BufferSlice buffer, DateTime value, int offset) => 
        Unsafe.WriteUnaligned(ref buffer.Array[buffer.Offset + offset],value.ToUniversalTime().Ticks);

    public static void Write(this BufferSlice buffer, PageAddress value, int offset)
    {
        Unsafe.WriteUnaligned(ref buffer.Array[buffer.Offset + offset], value.PageID);
        buffer[offset + 4] = value.Index;
    }

    public static void Write(this BufferSlice buffer, Guid value, int offset) => 
        value.TryWriteBytes(buffer.Array.AsSpan().Slice(buffer.Offset + offset, 16));
    ...
    {
        DEBUG(IndexNode.GetKeyLength(value, true) <= MAX_INDEX_KEY_LENGTH,
        ...
        else if (value.IsBinary)
        {
            ...
            ExtendedLengthHelper.WriteLength(BsonType.Binary, (ushort)arr.Length, out var typeByte,
                out var lengthByte);
